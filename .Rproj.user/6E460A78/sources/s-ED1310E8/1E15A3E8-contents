...
This was a talk I gave to our journal club on the use of long-read sequencers for genomics and RNA analysis. I follow a few of the people who post a lot of nanopore on twitter, and wanted to know a bit more about the technology (also to try out using [Xaringan](https://yihui.name/en/2017/08/why-xaringan-remark-js/) for making presentations).